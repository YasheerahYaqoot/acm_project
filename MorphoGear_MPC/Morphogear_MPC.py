...
def xy_trajectories(option):
    if option == 1:
        ...
        #--------------------Option 3 - Arbitrary Trajectory Points 
        x_values = [0, 15, 15, -15, -15, 15]
        y_values = [0, 0, 35, 35, -35, -35]
    return x_values, y_values

trajectory_option = 1  ###-----INPUT TRAJECTORY NUMBER TO BE TESTED-----###
