...
def simulation_legs_2D(Morphogear_data, t1_FL, t2_FL, t1_BR, t2_BR, t1_FR, t2_FR, t1_BL, t2_BL, step, Repeat):
    ...
    ani = FuncAnimation(fig, update, frames=range(count), fargs=(base_dia, base_thickness,
                  Femur_FL, Tibia_FL, Femur_BR, Tibia_BR, Femur_FR, Tibia_FR, Femur_BL, Tibia_BL, step),
                        interval=15, blit=True, repeat=Repeat)
    # ani.save('Limbs Simulation.gif', writer='pillow', fps=50)
    plt.show()
    return ani